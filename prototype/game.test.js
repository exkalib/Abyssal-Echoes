...

{
  ...
  assert.match(androidBuild,/versionCode 12/,'新版应用图标 APK 必须提升安装版本');
  assert.match(androidBuild,/versionName "0\.7\.1"/,'新版应用图标 APK 必须展示新的应用版本');
  assert.match(androidBuild,/SHELL_VERSION", "9"/,'原生图标更新必须提升外壳协议版本');
  assert.match(androidBuild,/BUNDLED_BUILD", "1788416012L"/,'最新 APK 必须内置本次完整资源版本');
